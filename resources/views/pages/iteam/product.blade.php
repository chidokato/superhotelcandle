<div class="col iteam-product">
    ...
    <div class="property-grid-1 property-block bg-white transation-this hover-shadow">
        <div class="overflow-hidden position-relative transation thumbnail-img bg-secondary hover-img-zoom">
            <a href="{{$data->category->slug}}/{{$val->post->slug}}"><img src="data/product/{{$val->post->img}}" alt="Image Not Found!"></a>
        ...
        <div class="property_text p-4">
            ...
            <span class="listing-location"><i class="fas fa-map-marker-alt"></i> {{$val->address}} </span>
        </div>
    </div>
</div>