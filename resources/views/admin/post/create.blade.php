        ...
        <div class="card shadow mb-2">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ul class="nav nav-pills">
                    <li><a data-toggle="tab" class="nav-link active" href="#vi">Tiếng Việt <span style="color: red">(*)</span></a></li>
                    <li><a data-toggle="tab" class="nav-link" href="#en">Tiếng Anh <span style="color: red">(*)</span></a></li>
                  ...
                  <div class="card-body">
                      <div class="row">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label>Sort description</label>
                                  <textarea rows="4" name="detail:jp" class="form-control"></textarea>
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
