            ...
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ul class="nav nav-pills">
                    ...
                    <li><a data-toggle="tab" class="nav-link <?php if($key==0){echo 'active';} ?>" href="#{{$val->locale}}">
                      @if($val->locale == 'vi') Tiếng Việt <span style="color: red">(*)</span> @endif
                      @if($val->locale == 'en') Tiếng Anh <span style="color: red">(*)</span> @endif
                      @if($val->locale == 'jp') Tiếng Nhật <span style="color: red">(*)</span> @endif
                    </a></li>
                    @endforeach
                </ul>
            </div>
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <input required="" value="{{$val->name}}" name="name:{{$val->locale}}" placeholder="..." type="text" class="form-control">
                              </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
